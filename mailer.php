...
function getThigazhEmailTemplate($title, $content) {
    ...
    <head>
        <style>
            body { font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #0a0a23; color: #dddddd; margin: 0; padding: 0; line-height: 1.6; }
            .container { max-width: 600px; margin: 20px auto; background-color: #0d0d2b; border: 2px solid #550000; box-shadow: 0 0 20px rgba(255, 0, 60, 0.2); overflow: hidden; border-radius: 8px; }
            .header { background: linear-gradient(135deg, #1a0000 0%, #330000 100%); padding: 30px; text-align: center; border-bottom: 3px solid #ff003c; }
